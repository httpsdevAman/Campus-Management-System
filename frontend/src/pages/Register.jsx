          ...
          <div className="flex flex-col lg:flex-row h-full">
            ...
            >
              <div className="w-full max-w-sm">
                ...
                >
                  Register using your official institute email
                </motion.p>
                  ...
                  <motion.div variants={stagger} className="space-y-4">
                    ...
                    <motion.div variants={fadeUp} className="pt-1">
                      <button
                        type="submit"
                        disabled={submitting}
                        className="w-full py-2.5 rounded-xl font-semibold text-sm text-white bg-gradient-to-r from-indigo-500 to-violet-500 shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30 hover:brightness-110 active:scale-[0.98] transition-all duration-300 cursor-pointer disabled:opacity-60 dark:shadow-indigo-500/20 dark:hover:shadow-indigo-500/30"
                      >
                ...
                <motion.p
                  variants={fadeUp}
                  className="mt-6 text-center text-sm text-slate-400 dark:text-white/30 transition-colors duration-500"
                >
